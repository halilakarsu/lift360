...
@section('title', 'Yeni Asansör Ekle')
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            <div class="header">
                <h2><strong>Yeni Asansör</strong> Bilgileri</h2>
            </div>
            <div class="body">
                <form method="POST" action="{{ route('lifts.store') }}" id="lift-form">
                    @csrf
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-12 col-md-12">
                            ...
                            <div class="form-group">                                
                                <input type="text" id="name" name="name" class="form-control" placeholder="Asansör Adı veya Barkod No" value="{{ old('name') }}" required>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                            <label for="building_name">Bina/Blok Adı</label>
                            <div class="form-group">                                
                                <input type="text" id="building_name" name="building_name" class="form-control" placeholder="Bina veya Blok Adı" value="{{ old('building_name') }}">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12">
                        ...
                        <div class="col-lg-12 text-right">
                            ...
                            <button type="button" onclick="document.getElementById('lift-form').submit();" class="btn btn-primary btn-round">Kaydet</button>
                        </div>
                    </div>
                </form>
            </div>
