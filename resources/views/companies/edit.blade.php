...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="body">
                <form method="POST" action="{{ route('companies.update', $company) }}" id="company-edit-form">
                    @csrf
                    @method('PATCH')
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12">
                            <button type="button" onclick="document.getElementById('company-edit-form').submit();" class="btn btn-primary btn-round">Güncelle</button>
