...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="card">
            ...
            <div class="body">
                <form method="POST" action="{{ route('companies.store') }}" id="company-create-form">
                    @csrf
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12">
                            <button type="button" onclick="document.getElementById('company-create-form').submit();" class="btn btn-primary btn-round">Kaydet</button>
