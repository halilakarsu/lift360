...
<body class="theme-blush">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img class="zmdi-hc-spin" src="{{ asset('aero-theme/assets/images/loader.svg') }}"
            ...
            <li>
                <form method="POST" action="{{ route('logout') }}" id="logout-form">
                    ...
                    <a href="javascript:void(0);" onclick="document.getElementById('logout-form').submit();"
                        class="mega-menu" title="Çıkış Yap">
    ...
    <aside id="leftsidebar" class="sidebar">
        <div class="navbar-brand">
            ...
            <a href="{{ route('dashboard') }}"><img
                    src="{{ asset('aero-theme/assets/images/custom/asansor360_logo.png') }}" width="120"
                    alt="Asansör 360"></a>
        </div>
        <div class="menu">
            <ul class="list">
                <li>
                    <div class="user-info">
                        <a class="image" href="{{ route('profile.edit') }}"><img
                                src="{{ asset('aero-theme/assets/images/profile_av.jpg') }}" alt="User"></a>
                        <div class="detail">
                ...
                <li class="{{ request()->routeIs('dashboard') ? 'active open' : '' }}"><a
                        href="{{ route('dashboard') }}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
                <li class="{{ request()->routeIs('companies.*') ? 'active open' : '' }}"><a
                        href="{{ route('companies.index') }}"><i class="zmdi zmdi-city"></i><span>Firmalar</span></a>
                </li>
                <li class="{{ request()->routeIs('users.*') ? 'active open' : '' }}"><a
                        href="{{ route('users.index') }}"><i
                            class="zmdi zmdi-accounts"></i><span>Kullanıcılar</span></a></li>
            </ul>
        </div>
    </aside>
